...
namespace Client.Providers
{
    public class ApiAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        {
            var savedToken = await sessionStorageService.GetItemAsync<string>(JwtConfig.JWT_TOKEN_NAME) ?? await localStorage.GetItemAsync<string>(JwtConfig.JWT_TOKEN_NAME);
